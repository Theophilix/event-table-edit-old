...
Download latest version 4.6.2 (since 10.02.2018, has bug, see latest issue, delete column separation not done yet): https://github.com/Theophilix/event-table-edit/archive/master.zip.
