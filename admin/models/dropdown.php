...
class EventtableeditModelDropdown extends JModelAdmin
{
     ...
     * @since	1.6
     */
    public function getTable($type = 'Dropdowns', $prefix = 'EventtableeditTable', $config = [])
    {
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        // Get the form.
        $form = $this->loadForm('com_eventtableedit.dropdowns', 'dropdowns', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState('com_eventtableedit.edit.dropdown.data', []);
